...
A explanation of the key aspects of the solution design, approach and rationale is provided in task [Documentation](https://github.com/markomilosevic9/creating-reporting-layer-in-dwh-for-bi/blob/main/Documentation.pdf) PDF file.
